...
// File: contracts/vaults/VaultCommon.sol
...
// File: contracts/vaults/gVault.sol
...
contract gVault is VaultCommon, ERC20 {
    ...
    constructor(address _token, address _controller)
        ...
        ERC20(string(abi.encodePacked("Garfield Finance ", ERC20(_token).name())), string(abi.encodePacked("g", ERC20(_token).symbol())))
    {
        token = IERC20(_token);
